...
Vertice::Vertice(unsigned id)
    :id(id), rotulo(Vertice::suscetivel), grau_entrada(0), grau_saida(0), forca(0), forca_entrada(0), forca_saida(0)
{
}
...
void Vertice::addArestaPropria(int indice)
{
    this->lista_arestas_proprias.push_back(indice);
}
